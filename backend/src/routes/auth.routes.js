...
import { registerUser, loginUser, getCurrentUser,  logoutUser,refreshAccessToken,} from "../controllers/auth.controller.js"; // import the registerUser function from the auth.controller.js file
import {
    verifyJWT,
    authorizeRoles,
